...
const CallToAction = () => (
  <div className="flex w-full max-w-md flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0 mt-8">
    <input
      type="email"
            ...
            <div className="flex flex-col items-center text-center max-w-5xl mx-auto space-y-10">
              <div className="space-y-6">
                ...
                <p className="mx-auto max-w-3xl md:text-xl dark:text-gray-400 text-black">
                  Consolidate, version, and permission your financial plans with two-way syncing between Excel, Google
                  Sheets, and your data warehouse.
                </p>
              </div>
              <CallToAction />
            </div>
            ...
            <div className="grid gap-8 lg:gap-16 lg:grid-cols-2 items-center">
              ...
              <div className="px-4 md:px-6">
                <div className="space-y-4">
                  <p className="text-sm tracking-widest uppercase text-black font-normal">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    <p className="text-black text-lg">
                      ...
                      <span className="font-bold">still using spreadsheets</span> for planning, reporting, and analysis.
                    </p>
                    <p className="text-black text-lg">
                  ...
                  <CardContent className="p-0">
                    <div className="space-y-4">
                      ...
                      <blockquote className="text-lg font-medium leading-relaxed">
                        "Planning software is really only used as a central source of truth. Planning happens outside of
                        it."
                      </blockquote>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    ...
                    <p className="text-black text-lg">
                      ...
                      <span className="font-bold">version control, centralized planning, and role-based access</span>,
                ...
                <Card className="p-6 bg-white border-gray-400">
                  <CardContent className="p-0">
                    <div className="space-y-4">
                      <Quote className="h-8 w-8 text-primary" />
                      <blockquote className="text-lg font-medium leading-relaxed">
                        "FP&A tools are focused on getting everyone into the product, but nobody wants to use it.
                        Everyone exports everything so they can import it to other tools."
                      </blockquote>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <p className="text-black text-lg">
                      ...
                      keep planning where you already work.
                    </p>
                    <p className="text-black text-lg">
                      No need to switch tools or learn a new formula language. Everything stays familiar, just more
                      reliable.
                    </p>
                  </div>
                </div>
                ...
                <Card className="p-6 bg-[#fff382] bg-white border-slate-400">
                  <CardContent className="p-0">
                    <div className="space-y-4">
                      <Quote className="h-8 w-8 text-primary" />
                      <blockquote className="text-lg font-medium leading-relaxed">
                        "Spreadsheets are alluring because you can do whatever you want. You can push spreadsheets very
                        far before you need something else."
                      </blockquote>
                      <p className="text-sm text-black">— Director of GTM Strategic Finance</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="grid gap-8 lg:gap-16 lg:grid-cols-2 items-center lg:grid-flow-col-dense">
              ...
              <div className="order-1 lg:order-2 px-4 md:px-6 lg:col-start-2">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <p className="text-black text-lg">
                      Most planning tools create yet <span className="font-bold">another data silo</span>.
                    </p>
                    <p className="text-black text-lg">
                      PlanningDB supports two-way syncing with your cloud data warehouse so you can model in spreadsheets
                      and <span className="font-bold">report from the warehouse</span>.
                    </p>
                    <p className="text-black text-lg">No extra exports. No extra steps.</p>
                  </div>
                </div>
              </div>
                ...
                <Card className="p-6 bg-white border-slate-400">
                  <CardContent className="p-0">
                    <div className="space-y-4">
                      <Quote className="h-8 w-8 text-primary" />
                      <blockquote className="text-lg font-medium leading-relaxed">
                        "EPM wants to be kind of like a data warehouse. They want you to bring in all the data. But I
                        don't want to be moving data around."
                      </blockquote>
                      <p className="text-sm text-black">— VP Strategic Finance</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">PlanningDB adds what spreadsheets lack</h2>
                <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 text-gray-800">
                  Get the flexibility of spreadsheets with the structure of a database.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-stretch gap-6 lg:grid-cols-3 lg:gap-12">
              ...
              <Card className="p-6 bg-white border-slate-400">
                <CardHeader className="pb-4">
                  <CardTitle className="text-center font-semibold">Consolidation</CardTitle>
                </CardHeader>
                <CardContent className="p-0 space-y-4">
                  <div className="space-y-3">
                    <p className="text-black">
                      Consolidate multiple spreadsheets into a single structured and reliable data source.
                    </p>
                  </div>
                  <div className="space-y-4 pt-4 border-t mt-4 border-slate-300">
                    <blockquote className="font-medium leading-relaxed text-sm">
                      "Every department does their own thing so spreadsheets proliferate and @#$%!&amp; becomes just a
                      repository."
                    </blockquote>
                    <p className="text-sm text-black">— Senior Manager, FP&A Systems</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 bg-white border-slate-400">
                <CardHeader className="pb-4">
                  <CardTitle className="text-center font-semibold">Version Control</CardTitle>
                </CardHeader>
                <CardContent className="p-0 space-y-4">
                  <div className="space-y-3">
                    <p className="text-black">
                      Lock finalized versions, compare plans vs actuals, and track every change in a full audit log.
                    </p>
                  </div>
                  <div className="space-y-4 pt-4 border-t mt-4 border-gray-300">
                    <blockquote className="font-medium leading-relaxed text-sm">
                      "Planning tools like @#$%!& are basically for version control."
                    </blockquote>
                    <p className="text-sm text-black">— Senior Finance Manager</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 bg-white border-slate-400">
                <CardHeader className="pb-4">
                  <CardTitle className="text-center font-semibold">Permissions</CardTitle>
                </CardHeader>
                <CardContent className="p-0 space-y-4">
                  <div className="space-y-3">
                    <p className="text-black">
                      Define who can view or edit by role, dimension, and model with simple access controls.
                    </p>
                  </div>
                  <div className="space-y-4 pt-4 border-t mt-4 border-gray-300">
                    <blockquote className="font-medium leading-relaxed text-sm">
            ...
            <div className="flex flex-col items-center justify-center text-center space-y-10">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] md:text-xl dark:text-gray-400 text-gray-800">
                  PlanningDB fits into the tools your team already uses without the overhead of managing a complex system.
                </p>
              </div>
              <CallToAction />
            </div>
